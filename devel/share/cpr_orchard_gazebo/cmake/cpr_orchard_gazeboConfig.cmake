...
if("TRUE" STREQUAL "TRUE")
  set(cpr_orchard_gazebo_SOURCE_PREFIX /home/adeeb/asparagus_ws/src/cpr_gazebo/cpr_orchard_gazebo)
  set(cpr_orchard_gazebo_DEVEL_PREFIX /home/adeeb/asparagus_ws/devel)
  ...
  set(cpr_orchard_gazebo_INSTALL_PREFIX /home/adeeb/asparagus_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'cpr_orchard_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/adeeb/asparagus_ws/src/cpr_gazebo/cpr_orchard_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  list(APPEND cpr_orchard_gazebo_EXPORTED_TARGETS ${${cpr_orchard_gazebo_dep}_EXPORTED_TARGETS})
endforeach()
